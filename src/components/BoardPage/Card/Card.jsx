...
import { PriorityCircle, TruncatedText, TruncatedTextWithMargin, CustomCard, CardContentWrapper, TitleTypography, PriorityTypography, DeadlineTypography, PriorityWrapper, DedlineWrapper, PriorityDateContainer, PriorityDateItem, WhiteIcon, Icons, BottomInfo, DeadlineInfo, PriorityInfo } from '../Card/Card.styled'
                ...
                < BottomInfo >
                    <PriorityDateContainer>
                        <PriorityDateItem>
                            ...
                            <PriorityWrapper>
                                <PriorityCircle style={{ backgroundColor: priorityCircleColor }} />
                                <PriorityInfo>
