...
<Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
    {formik=><Form>
        ...
        <FormikController control='radio' label='radiotopic' name='radioOptions' options={radioOptions}/>
        <FormikController control='select' label='Select a topic' name='dropdownOptions' options={dropdownOptions}/>
